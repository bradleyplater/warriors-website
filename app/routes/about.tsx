    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-6">About the Warriors</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">Who We Are</h2>
        ...
        {/* Image Showcase */}
        <div className="mb-16">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 text-center mb-12">Our Journey</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-lg font-bold text-gray-900 mb-3">Celebrating Success</h3>
                <p className="text-sm text-gray-700">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-lg font-bold text-gray-900 mb-3">Team Unity</h3>
                <p className="text-sm text-gray-700">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 md:p-12 text-white text-center mb-16">
          <h2 className="text-2xl md:text-3xl font-bold mb-6">Ready to Join the Warriors?</h2>
        ...
        <div className="text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">Connect With Us</h2>
